...
```{r}
#| echo: false
blogdown::shortcode("youtube", "5s7fI4cl2C8")
```
...
A file of environment variables for Docker should _not_ have quotes around the variables; this is different than environment variables for R, which can have quotes. Specify your variables in this file like `CONNECT_SERVER=https://colorado.rstudio.com/rsc/`.
